...
{
	Vector4 firstPoint = Vector4(-0.5f, -0.5f, 0.0f);
	...
	if (filePath == "small")
	{
		...
		secondPoint = Vector4(-0.25f, -0.75f, 0.0f);
		thirdPoint = Vector4(-0.5f, -0.25f, 0.0f);
	}
...
//		{
//			return Vector4(this->X + right.X, this->Y + right.Y, this->Z + right.Z);
//		}
//		// Subtraction Operator Overload
//		Vector4 operator-(const Vector4& right) const
//		{
...
//		{
//			return Vector4(this->X * other, this->Y * other, this->Z * other);
//		}
...
//		Vector4 CrossV3(const Vector4 a, const Vector4 b)
//		{
...
//		float MagnitudeV3(const Vector4 in)
//		{
//			return (sqrtf(powf(in.X, 2) + powf(in.Y, 2) + powf(in.Z, 2)));
//		}
//
//		// Vector4 DotProduct
//		float DotV3(const Vector4 a, const Vector4 b)
//		{
//			return (a.X * b.X) + (a.Y * b.Y) + (a.Z * b.Z);
//		}
//
//		// Angle between 2 Vector4 Objects
//		float AngleBetweenV3(const Vector4 a, const Vector4 b)
//		{
...
//		Vector4 ProjV3(const Vector4 a, const Vector4 b)
//		{
//			Vector4 bn = b / MagnitudeV3(b);
...
//		{
//			return Vector4(right.X * left, right.Y * left, right.Z * left);
//		}
//
//		// A test to see if P1 is on the same side as P2 of a line segment ab
//		bool SameSide(Vector4 p1, Vector4 p2, Vector4 a, Vector4 b)
//		{
//			Vector4 cp1 = math::CrossV3(b - a, p1 - a);
//			Vector4 cp2 = math::CrossV3(b - a, p2 - a);
//
...
//		Vector4 GenTriNormal(Vector4 t1, Vector4 t2, Vector4 t3)
//		{
//			Vector4 u = t2 - t1;
//			Vector4 v = t3 - t1;
//
//			Vector4 normal = math::CrossV3(u, v);
//
//			return normal;
//		}
//
//		// Check to see if a Vector4 Point is within a 3 Vector4 Triangle
//		bool inTriangle(Vector4 point, Vector4 tri1, Vector4 tri2, Vector4 tri3)
//		{
...
//			Vector4 n = GenTriNormal(tri1, tri2, tri3);
//
//			// Project the point onto this normal
//			Vector4 proj = math::ProjV3(point, n);
//
...
//			const std::vector<Vector4>& iPositions,
//			const std::vector<Vector2>& iTCoords,
//			const std::vector<Vector4>& iNormals,
//			std::string icurline)
//		{
...
//			if (noNormal)
//			{
//				Vector4 A = oVerts[0].Position - oVerts[1].Position;
//				Vector4 B = oVerts[2].Position - oVerts[1].Position;
//
//				Vector4 normal = math::CrossV3(A, B);
//
